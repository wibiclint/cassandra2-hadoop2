...
public class TestInputFormatWithBackgroundCassandra {
  ...
  private static final String HOSTIP = "192.168.200.12";
  ...
  @Test
  public void testSlicePredicate() throws IOException {
    ////////////////////////////////////////////////////////////////////////////
    // Set Cassandra / Hadoop input options.
    Configuration conf = new Configuration();
    ConfigHelper.setInputRpcPort(conf, "9160");
    ConfigHelper.setInputNativeTransportPort(conf, "9042");
    ...
    DataStaxCqlPagingInputFormat inputFormat = new DataStaxCqlPagingInputFormat();

    List<InputSplit> inputSplitList = inputFormat.getSplitsFromConf(conf);
